...
export async function deliverProductToGitHub(record) {
  ...
  const branch = `cofounder-live/${missionId}-r${product.revision}`;
  ...
  const capability = record.mvp?.googleCapability;
...
- Google capability: **${capability?.label || capability?.service || "Google Cloud"}**

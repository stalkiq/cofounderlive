...
import { prepareGoogleCapabilities } from "./google-capabilities.mjs";
...
Review whether Technical chose the right archetype, device format, navigation, screen types, core workflow, visual hierarchy, product-specific motif, and one or two Google capabilities. Every capability must be functional, useful rather than decorative, complementary to the other capability, and aligned to a compatible primary screen. Be direct. You may request a different supported screen type or capability if it better fits the founder's idea.
Return ONLY JSON:
{
  "score":7,
  "verdict":"one direct sentence",
